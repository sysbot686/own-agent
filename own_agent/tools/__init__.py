...
from own_agent.tools.plan import PLAN_SPEC, plan
...
from own_agent.tools.web import WEB_FETCH_SPEC, WEB_SEARCH_SPEC, web_fetch, web_search

__all__ = [
    "ToolSpec", "ToolResult", "ToolRegistry", "ExecutionContext",
    "think", "plan", "ls", "view", "write", "edit", "grep", "glob", "shell", "python_exec",
...
def register_all_tools(registry: ToolRegistry) -> None:
    ...
    registry.register(PLAN_SPEC, plan)
    ...
    registry.register(WEB_SEARCH_SPEC, web_search)
    registry.register(WEB_FETCH_SPEC, web_fetch)
